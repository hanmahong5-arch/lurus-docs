...
| 服务 | 域名 | 状态 |
|------|------|------|
| LLM API 网关 | https://api.lurus.cn | Active |
| API 文档 | https://docs.lurus.cn | Active |
| ArgoCD | https://argocd.lurus.cn | Active |
| Grafana | https://grafana.lurus.cn | Active |
| Prometheus | https://prometheus.lurus.cn | Active |
| NATS Monitor | https://nats.lurus.cn | Active |
| Jaeger | https://jaeger.lurus.cn | Active |
| Loki | https://loki.lurus.cn | Active |
