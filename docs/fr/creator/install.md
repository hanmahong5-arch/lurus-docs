...
4. **Première configuration** : récupérez votre Key sur [hub.lurus.cn](https://hub.lurus.cn) et collez-la dans les réglages de Creator (utilisée pour la réécriture par l'IA).
