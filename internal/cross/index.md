...
| 一句话 | 产品 |
|---|---|
| 谁付了钱 / 还能用什么功能 | [Platform](/products/platform) |
| 大模型代理人，OpenAI 兼容 | [Newapi](/products/newapi) |
| 长期记忆 | [MemX](/products/memx) |
| 能中断恢复的 Agent 引擎 | [Kova](/products/kova) |
| Agent 开发 CLI（含 LangGraph 兼容 checkpointer） | [Lumen](/products/lumen) |
| 可视化 Agent 工作台（PM 友好） | [Forge](/products/forge) |
| AI 量化交易 | [Lucrum](/products/lucrum) |
| AI 进销存 SaaS（规划） | [Tally](/products/tally) |
| 桌面 AI 网关（多模型 + MCP） | [Switch](/products/switch) |
| 桌面内容工厂（视频/图文 pipeline） | [Creator](/products/creator) |
| 移动端总入口（Flutter） | [Lutu](/products/lutu) |
| 公网门面（Next.js + Phoenix 游戏） | [Web](/products/web) |
| 内部管理后台（Phoenix） | [Admin](/products/admin) |
| 后台运维 chat 化（zitadel/k8s/platform） | [MCP servers](/products/mcp) |
...
- **新工程师**：[集成配方](/cross/integration-recipes) → 读你接手产品手册的 "端到端完整例子" 章节 → [运维 SOP](/ops/)。
